...
function eduClickOne() {
	//document.getElementById("aboutBox").innerHTML = "While working as a Client Service Advisor, I directly aided a corporate client in recovering over $100,000 in stolen funds after the CEO's email was compromised. That incident drew my interest towards Information Security. That interest became a hobby and then a passion. In 2020 I decided to realign my career towards tech while leveraging self-learning, traditional education, and 5+ years of corporate finance experience.";
	//document.getElementById("aboutIntroBlurb").element.className = "hidden";
	document.getElementById("eduBlurbOne").classList.add('nothidden');
	document.getElementById("eduBlurbOne").classList.remove('hidden');


	document.getElementById("eduIntroBlurb").classList.add('hidden');
	document.getElementById("eduIntroBlurb").classList.remove('nothidden');
	document.getElementById("eduBlurbTwo").classList.add('hidden');
	document.getElementById("eduBlurbTwo").classList.remove('nothidden');
	document.getElementById("eduBlurbThree").classList.add('hidden');
	document.getElementById("eduBlurbThree").classList.remove('nothidden');

	
}

function eduClickTwo() {
	//document.getElementById("aboutBox").innerHTML = "Before learning to pursue a tech-focused career, I was a finance professional. I started as a part-time teller. Within five years, I was traveling across the states to meet with high-profile commercial clients and present treasury proposals. Highlights Include:Yada Yada Yada";

	document.getElementById("eduBlurbTwo").classList.add('nothidden');
	document.getElementById("eduBlurbTwo").classList.remove('hidden');


	document.getElementById("eduIntroBlurb").classList.add('hidden');
	document.getElementById("eduIntroBlurb").classList.remove('nothidden');
	document.getElementById("eduBlurbOne").classList.add('hidden');
	document.getElementById("eduBlurbOne").classList.remove('nothidden');
	document.getElementById("eduBlurbThree").classList.add('hidden');
	document.getElementById("eduBlurbThree").classList.remove('nothidden');
...
function eduClickThree() {
	//document.getElementById("aboutBox").innerHTML = "Wouldn't You Like to Know";

	document.getElementById("eduBlurbThree").classList.add('nothidden');
	document.getElementById("eduBlurbThree").classList.remove('hidden');
...
function skillClickOne() {
	//document.getElementById("aboutBox").innerHTML = "While working as a Client Service Advisor, I directly aided a corporate client in recovering over $100,000 in stolen funds after the CEO's email was compromised. That incident drew my interest towards Information Security. That interest became a hobby and then a passion. In 2020 I decided to realign my career towards tech while leveraging self-learning, traditional education, and 5+ years of corporate finance experience.";
	//document.getElementById("aboutIntroBlurb").element.className = "hidden";
	document.getElementById("skillBlurbOne").classList.add('nothidden');
	document.getElementById("skillBlurbOne").classList.remove('hidden');
...
function skillClickTwo() {
	...
	document.getElementById("skillBlurbTwo").classList.add('nothidden');
	document.getElementById("skillBlurbTwo").classList.remove('hidden');


	document.getElementById("skillIntroBlurb").classList.add('hidden');
	document.getElementById("skillIntroBlurb").classList.remove('nothidden');
	document.getElementById("skillBlurbOne").classList.add('hidden');
	document.getElementById("skillBlurbOne").classList.remove('nothidden');
	document.getElementById("skillBlurbThree").classList.add('hidden');
	document.getElementById("skillBlurbThree").classList.remove('nothidden');

}

function skillClickThree() {
	//document.getElementById("aboutBox").innerHTML = "Wouldn't You Like to Know";

	document.getElementById("skillBlurbThree").classList.add('nothidden');
	document.getElementById("skillBlurbThree").classList.remove('hidden');
